...
(function(exports) {
  ...
  var NoPerson = (function () {
      function NoPerson() {

      };
      NoPerson.value = new NoPerson();
      return NoPerson;
  })();
  var North = (function () {
      function North() {
  ...
  var Destination = (function () {
      function Destination(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Destination.create = function (value0) {
          return function (value1) {
              return new Destination(value0, value1);
          };
      };
      return Destination;
  })();
  var NoDestination = (function () {
      function NoDestination() {

      };
      NoDestination.value = new NoDestination();
  ...
  var DestinationCell = (function () {
      function DestinationCell(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      DestinationCell.create = function (value0) {
          return function (value1) {
              return new DestinationCell(value0, value1);
          };
      };
      return DestinationCell;
  })();
  var PersonCell = (function () {
      function PersonCell(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      PersonCell.create = function (value0) {
          return function (value1) {
              return new PersonCell(value0, value1);
          };
      };
      return PersonCell;
  })();
  ...
  var Move = (function () {
      function Move(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Move.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Move(value0, value1, value2);
              };
          };
      };
      return Move;
  ...
  var WallCell = (function () {
      function WallCell(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      WallCell.create = function (value0) {
          return function (value1) {
              return new WallCell(value0, value1);
          };
      };
      return WallCell;
  })();
  var Cell = (function () {
      function Cell(value0, value1, value2, value3) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
          this.value3 = value3;
      ...
      Cell.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return function (value3) {
                      return new Cell(value0, value1, value2, value3);
                  };
              };
          };
      };
  ...
  var initWalls = Data_List.fromFoldable(Data_Foldable.foldableArray)([ new WallCell(new Coord(3, 0), Vertical.value), new WallCell(new Coord(1, 2), Both.value), new WallCell(new Coord(0, 1), Horizontal.value) ]);
  var initPeople = Data_List.fromFoldable(Data_Foldable.foldableArray)([ new PersonCell(new Coord(0, 3), Red.value), new PersonCell(new Coord(2, 3), Blue.value), new PersonCell(new Coord(0, 0), Yellow.value) ]);
  var initDestinations = Data_List.fromFoldable(Data_Foldable.foldableArray)([ new DestinationCell(new Coord(1, 2), new Destination(Moon.value, Blue.value)), new DestinationCell(new Coord(3, 0), new Destination(Moon.value, Red.value)) ]);
  var groupGrid = function ($630) {
      return Data_Functor.map(Data_List_Types.functorList)(Data_List_Types.toList)(Data_List.groupBy(function (v) {
          return function (v1) {
              return v.value0.value0 === v1.value0.value0;
          };
      })($630));
  };
  var grid = Control_Bind.bind(Data_List_Types.bindList)(Data_List.range(0)(3))(function (v) {
      return Control_Bind.bind(Data_List_Types.bindList)(Data_List.range(3)(0))(function (v1) {
          return Control_Applicative.pure(Data_List_Types.applicativeList)(new Cell(new Coord(v, v1), NoPerson.value, NoWall.value, NoDestination.value));
      });
  });
  var genericWallCell = new Data_Generic_Rep.Generic(function (x) {
      return new Data_Generic_Rep.Product(x.value0, x.value1);
  }, function (x) {
      return new WallCell(x.value0, x.value1);
  });
  var genericWall = new Data_Generic_Rep.Generic(function (x) {
      ...
      if (x instanceof NoWall) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(Data_Generic_Rep.NoArguments.value)));
      };
      throw new Error("Failed pattern match at Main line 77, column 8 - line 77, column 46: " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var showWall = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericWall)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "Vertical";
  ...
  var genericTile = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof Moon) {
          return new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value);
      };
      if (x instanceof Square) {
          return new Data_Generic_Rep.Inr(Data_Generic_Rep.NoArguments.value);
      };
      throw new Error("Failed pattern match at Main line 82, column 8 - line 82, column 46: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return Moon.value;
      };
  ...
  var showTile = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericTile)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "Moon";
  })))(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "Square";
  })))));
  var genericPersonCell = new Data_Generic_Rep.Generic(function (x) {
      return new Data_Generic_Rep.Product(x.value0, x.value1);
  }, function (x) {
      return new PersonCell(x.value0, x.value1);
  });
  var genericPerson = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof Red) {
          return new Data_Generic_Rep.Inl(Data_Generic_Rep.NoArguments.value);
      };
      ...
      if (x instanceof NoPerson) {
          return new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(new Data_Generic_Rep.Inr(Data_Generic_Rep.NoArguments.value)));
      };
      throw new Error("Failed pattern match at Main line 75, column 8 - line 75, column 50: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return Red.value;
      };
      ...
      if (x instanceof Data_Generic_Rep.Inr && (x.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0 instanceof Data_Generic_Rep.Inr)) {
          return NoPerson.value;
      };
      throw new Error("Failed pattern match at Main line 75, column 8 - line 75, column 50: " + [ x.constructor.name ]);
  });
  var showPerson = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericPerson)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "Red";
  })))(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "Blue";
  })))(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
  ...
  var genericDirection = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Main line 81, column 8 - line 81, column 56: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return North.value;
      };
  ...
  var genericDestinationCell = new Data_Generic_Rep.Generic(function (x) {
      return new Data_Generic_Rep.Product(x.value0, x.value1);
  }, function (x) {
      return new DestinationCell(x.value0, x.value1);
  });
  var genericDestination = new Data_Generic_Rep.Generic(function (x) {
      if (x instanceof Destination) {
          return new Data_Generic_Rep.Inl(new Data_Generic_Rep.Product(x.value0, x.value1));
      };
      if (x instanceof NoDestination) {
          return new Data_Generic_Rep.Inr(Data_Generic_Rep.NoArguments.value);
      };
      throw new Error("Failed pattern match at Main line 83, column 8 - line 83, column 60: " + [ x.constructor.name ]);
  }, function (x) {
      if (x instanceof Data_Generic_Rep.Inl) {
          return new Destination(x.value0.value0, x.value0.value1);
      };
      if (x instanceof Data_Generic_Rep.Inr) {
          return NoDestination.value;
      };
      throw new Error("Failed pattern match at Main line 83, column 8 - line 83, column 60: " + [ x.constructor.name ]);
  });
  var showDestination = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericDestination)(Data_Generic_Rep_Show.genericShowSum(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsProduct(Data_Generic_Rep_Show.genericShowArgsArgument(showTile))(Data_Generic_Rep_Show.genericShowArgsArgument(showPerson)))(new Data_Symbol.IsSymbol(function () {
      return "Destination";
  })))(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsNoArguments)(new Data_Symbol.IsSymbol(function () {
      return "NoDestination";
  })))));
  var genericCoord = new Data_Generic_Rep.Generic(function (x) {
      return new Data_Generic_Rep.Product(x.value0, x.value1);
  }, function (x) {
      return new Coord(x.value0, x.value1);
  });
  var showCoord = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericCoord)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsProduct(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showInt))(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Show.showInt)))(new Data_Symbol.IsSymbol(function () {
      return "Coord";
  }))));
  var showDestinationCell = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericDestinationCell)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsProduct(Data_Generic_Rep_Show.genericShowArgsArgument(showCoord))(Data_Generic_Rep_Show.genericShowArgsArgument(showDestination)))(new Data_Symbol.IsSymbol(function () {
      return "DestinationCell";
  }))));
  var showPersonCell = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericPersonCell)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsProduct(Data_Generic_Rep_Show.genericShowArgsArgument(showCoord))(Data_Generic_Rep_Show.genericShowArgsArgument(showPerson)))(new Data_Symbol.IsSymbol(function () {
      return "PersonCell";
  }))));
  var showWallCell = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericWallCell)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsProduct(Data_Generic_Rep_Show.genericShowArgsArgument(showCoord))(Data_Generic_Rep_Show.genericShowArgsArgument(showWall)))(new Data_Symbol.IsSymbol(function () {
      return "WallCell";
  }))));
  var genericCell = new Data_Generic_Rep.Generic(function (x) {
      ...
      return new Cell(x.value0, x.value1.value0, x.value1.value1.value0, x.value1.value1.value1);
  });
  var showCell = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericCell)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsProduct(Data_Generic_Rep_Show.genericShowArgsArgument(showCoord))(Data_Generic_Rep_Show.genericShowArgsProduct(Data_Generic_Rep_Show.genericShowArgsArgument(showPerson))(Data_Generic_Rep_Show.genericShowArgsProduct(Data_Generic_Rep_Show.genericShowArgsArgument(showWall))(Data_Generic_Rep_Show.genericShowArgsArgument(showDestination)))))(new Data_Symbol.IsSymbol(function () {
      return "Cell";
  }))));
  var eqWall = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof NoWall && y instanceof NoWall) {
              return true;
          };
          return false;
      };
  });
  var ordWall = new Data_Ord.Ord(function () {
      return eqWall;
  }, function (x) {
      return function (y) {
          if (x instanceof Vertical && y instanceof Vertical) {
          ...
          if (y instanceof Both) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof NoWall && y instanceof NoWall) {
              return Data_Ordering.EQ.value;
          };
          throw new Error("Failed pattern match at Main line 111, column 8 - line 111, column 35: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var eqTile = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Moon && y instanceof Moon) {
              return true;
          };
  ...
  var ordTile = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          ...
          if (y instanceof Moon) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof Square && y instanceof Square) {
              return Data_Ordering.EQ.value;
          };
          throw new Error("Failed pattern match at Main line 115, column 8 - line 115, column 36: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var eqPerson = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof NoPerson && y instanceof NoPerson) {
              return true;
          };
          return false;
      };
  });
  var ordPerson = new Data_Ord.Ord(function () {
      return eqPerson;
  }, function (x) {
      return function (y) {
          if (x instanceof Red && y instanceof Red) {
          ...
          throw new Error("Failed pattern match at Main line 109, column 8 - line 109, column 40: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var eqDestination = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Destination && y instanceof Destination) {
              return Data_Eq.eq(eqTile)(x.value0)(y.value0) && Data_Eq.eq(eqPerson)(x.value1)(y.value1);
          };
          if (x instanceof NoDestination && y instanceof NoDestination) {
              return true;
          };
          return false;
      };
  });
  var ordDestination = new Data_Ord.Ord(function () {
      return eqDestination;
  }, function (x) {
      return function (y) {
          if (x instanceof Destination && y instanceof Destination) {
              var v = Data_Ord.compare(ordTile)(x.value0)(y.value0);
              if (v instanceof Data_Ordering.LT) {
                  return Data_Ordering.LT.value;
              };
              if (v instanceof Data_Ordering.GT) {
              ...
              return Data_Ord.compare(ordPerson)(x.value1)(y.value1);
          };
          if (x instanceof Destination) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof Destination) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof NoDestination && y instanceof NoDestination) {
              return Data_Ordering.EQ.value;
          };
          throw new Error("Failed pattern match at Main line 117, column 8 - line 117, column 50: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var eqCoord = new Data_Eq.Eq(function (x) {
      return function (y) {
          return x.value0 === y.value0 && x.value1 === y.value1;
      };
  });
  var eqPersonCell = new Data_Eq.Eq(function (x) {
      return function (y) {
          return Data_Eq.eq(eqCoord)(x.value0)(y.value0) && Data_Eq.eq(eqPerson)(x.value1)(y.value1);
      };
  });
  var findDestination = function (c) {
      return Data_Foldable.find(Data_List_Types.foldableList)(function (v) {
          return Data_Eq.eq(eqCoord)(v.value0)(c);
      });
  };
  var findPerson = function (c) {
      return Data_Foldable.find(Data_List_Types.foldableList)(function (v) {
          return Data_Eq.eq(eqCoord)(v.value0)(c);
      });
  };
  var findWall = function (c) {
      return Data_Foldable.find(Data_List_Types.foldableList)(function (v) {
          return Data_Eq.eq(eqCoord)(v.value0)(c);
      });
  };
  var ordCoord = new Data_Ord.Ord(function () {
      return eqCoord;
  }, function (x) {
      return function (y) {
  ...
  var eqCell = new Data_Eq.Eq(function (x) {
      return function (y) {
          return Data_Eq.eq(eqCoord)(x.value0)(y.value0) && Data_Eq.eq(eqPerson)(x.value1)(y.value1) && Data_Eq.eq(eqWall)(x.value2)(y.value2) && Data_Eq.eq(eqDestination)(x.value3)(y.value3);
      };
  });
  var ordCell = new Data_Ord.Ord(function () {
      ...
      return function (y) {
          var v = Data_Ord.compare(ordCoord)(x.value0)(y.value0);
          if (v instanceof Data_Ordering.LT) {
              return Data_Ordering.LT.value;
          };
          if (v instanceof Data_Ordering.GT) {
          ...
          var v1 = Data_Ord.compare(ordPerson)(x.value1)(y.value1);
          ...
          var v2 = Data_Ord.compare(ordWall)(x.value2)(y.value2);
          if (v2 instanceof Data_Ordering.LT) {
              return Data_Ordering.LT.value;
          };
          ...
          return Data_Ord.compare(ordDestination)(x.value3)(y.value3);
      };
  });
  var filt = function (dir) {
      return function (v) {
          var ops = function (v1) {
              if (v1 instanceof West) {
                  return {
                      compX: Data_Ord.lessThanOrEq(Data_Ord.ordInt),
                      compY: Data_Eq.eq(Data_Eq.eqInt),
                      ord: Data_List.reverse
                  };
              };
              if (v1 instanceof East) {
                  return {
                      compX: Data_Ord.greaterThanOrEq(Data_Ord.ordInt),
                      compY: Data_Eq.eq(Data_Eq.eqInt),
                      ord: Control_Category.identity(Control_Category.categoryFn)
                  };
              };
              if (v1 instanceof North) {
                  return {
                      compX: Data_Eq.eq(Data_Eq.eqInt),
                      compY: Data_Ord.lessThanOrEq(Data_Ord.ordInt),
                      ord: Control_Category.identity(Control_Category.categoryFn)
                  };
              };
              if (v1 instanceof South) {
                  return {
                      compX: Data_Eq.eq(Data_Eq.eqInt),
                      compY: Data_Ord.greaterThanOrEq(Data_Ord.ordInt),
                      ord: Data_List.reverse
                  };
              };
              throw new Error("Failed pattern match at Main line 244, column 5 - line 244, column 28: " + [ v1.constructor.name ]);
          };
          var ops$prime = ops(dir);
          var collectValidTiles = function (v1) {
              return function (v2) {
                  if (v1 instanceof West && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof Vertical))) {
                      return new Data_List_Types.Cons(v2.value0, Data_List_Types.Nil.value);
                  };
                  if (v1 instanceof West && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof Both))) {
                      return new Data_List_Types.Cons(v2.value0, Data_List_Types.Nil.value);
                  };
                  if (v1 instanceof West && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof Horizontal))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof West && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof NoWall))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof West && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof Vertical && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, Data_List_Types.Nil.value);
                  };
                  if (v1 instanceof West && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof Both && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, Data_List_Types.Nil.value);
                  };
                  if (v1 instanceof West && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof Horizontal && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof West && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof NoWall && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof East && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof Vertical))) {
                      return Data_List_Types.Nil.value;
                  };
                  if (v1 instanceof East && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof Both))) {
                      return Data_List_Types.Nil.value;
                  };
                  if (v1 instanceof East && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof Horizontal))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof East && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof NoWall))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof East && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof Vertical && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return Data_List_Types.Nil.value;
                  };
                  if (v1 instanceof East && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof Both && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof East && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof Horizontal && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof East && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof NoWall && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof South && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof Vertical))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof South && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof Both))) {
                      return new Data_List_Types.Cons(v2.value0, Data_List_Types.Nil.value);
                  };
                  if (v1 instanceof South && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof Horizontal))) {
                      return new Data_List_Types.Cons(v2.value0, Data_List_Types.Nil.value);
                  };
                  if (v1 instanceof South && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof NoWall))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof South && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof Vertical && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof South && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof Both && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, Data_List_Types.Nil.value);
                  };
                  if (v1 instanceof South && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof Horizontal && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, Data_List_Types.Nil.value);
                  };
                  if (v1 instanceof South && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof NoWall && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof North && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof Vertical))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof North && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof Both))) {
                      return Data_List_Types.Nil.value;
                  };
                  if (v1 instanceof North && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof Horizontal))) {
                      return Data_List_Types.Nil.value;
                  };
                  if (v1 instanceof North && (v2 instanceof Data_List_Types.Cons && (v2.value0.value1 instanceof NoPerson && v2.value0.value2 instanceof NoWall))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof North && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof Vertical && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof North && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof Both && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof North && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof Horizontal && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  if (v1 instanceof North && (v2 instanceof Data_List_Types.Cons && (v2.value0.value2 instanceof NoWall && Data_Eq.eq(eqPerson)(v.value1)(v2.value0.value1)))) {
                      return new Data_List_Types.Cons(v2.value0, collectValidTiles(dir)(v2.value1));
                  };
                  return Data_List_Types.Nil.value;
              };
          ...
          return function ($631) {
              return collectValidTiles(dir)(Data_List.filter(function (v1) {
                  return ops$prime.compX(v1.value0.value0)(v.value0.value0) && ops$prime.compY(v.value0.value1)(v1.value0.value1);
              })((ops(dir)).ord(Data_List.sort(ordCell)($631))));
          };
      };
  };
  var movePerson = function (v) {
      return function (direction) {
          return function ($632) {
              return Data_Maybe.maybe(v)(Control_Category.identity(Control_Category.categoryFn))(Data_List.last(Data_Functor.map(Data_List_Types.functorList)(function (v1) {
                  return new PersonCell(v1.value0, v.value1);
              })(filt(direction)(new PersonCell(v.value0, v.value1))(Data_List.fromFoldable(Data_List_Types.foldableList)($632)))));
          };
      };
  };
  var cellToHtml = function (v) {
      return function (v1) {
          var toggledClass = function (v2) {
              if (v2 instanceof Data_Maybe.Just && (Data_Eq.eq(eqCoord)(v2.value0.value0)(v1.value0) && Data_Eq.eq(eqPerson)(v2.value0.value1)(v1.value1))) {
                  return "toggled ";
              };
              return "";
          };
          var genWall = function (className) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("wall " + className)) ])([  ]);
          };
          var walls = (function () {
              if (v1.value2 instanceof Vertical) {
                  return [ genWall("vertical ") ];
              };
              if (v1.value2 instanceof Horizontal) {
                  return [ genWall("horizontal ") ];
              };
              if (v1.value2 instanceof Both) {
                  return [ genWall("vertical "), genWall("horizontal ") ];
              };
              if (v1.value2 instanceof NoWall) {
                  return [  ];
              };
              throw new Error("Failed pattern match at Main line 327, column 13 - line 333, column 19: " + [ v1.value2.constructor.name ]);
          })();
          var genTile = function (t) {
              if (t instanceof Moon) {
                  return "moon ";
              };
              if (t instanceof Square) {
                  return "square ";
              };
              throw new Error("Failed pattern match at Main line 341, column 17 - line 345, column 5: " + [ t.constructor.name ]);
          };
          var genPersonColour = function (p) {
              if (p instanceof Blue) {
                  return "blue ";
              };
              if (p instanceof Red) {
                  return "red ";
              };
              if (p instanceof Yellow) {
                  return "yellow ";
              };
              if (p instanceof NoPerson) {
                  return "";
              };
              throw new Error("Failed pattern match at Main line 346, column 25 - line 352, column 1: " + [ p.constructor.name ]);
          };
          var people = (function () {
              if (v1.value1 instanceof NoPerson) {
                  return [  ];
              };
              return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("person icon " + genPersonColour(v1.value1))) ])([  ]) ];
          })();
          var destinations = (function () {
              if (v1.value3 instanceof NoDestination) {
                  return [  ];
              };
              if (v1.value3 instanceof Destination) {
                  return [ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("icon tile " + (genTile(v1.value3.value0) + genPersonColour(v1.value3.value1)))) ])([  ]) ];
              };
              throw new Error("Failed pattern match at Main line 336, column 20 - line 338, column 113: " + [ v1.value3.constructor.name ]);
          })();
          var clickHandler = function (v2) {
              return function (v3) {
                  return function (v4) {
                      if (v2 instanceof Data_Maybe.Just && (v4 instanceof NoPerson && (v2.value0.value0.value0 > v1.value0.value0 && v2.value0.value0.value1 === v1.value0.value1))) {
                          return Move.create(v2)(West.value);
                      };
                      if (v2 instanceof Data_Maybe.Just && (v4 instanceof NoPerson && (v2.value0.value0.value0 < v1.value0.value0 && v2.value0.value0.value1 === v1.value0.value1))) {
                          return Move.create(v2)(East.value);
                      };
                      if (v2 instanceof Data_Maybe.Just && (v4 instanceof NoPerson && (v2.value0.value0.value1 > v1.value0.value1 && v2.value0.value0.value0 === v1.value0.value0))) {
                          return Move.create(v2)(South.value);
                      };
                      if (v2 instanceof Data_Maybe.Just && (v4 instanceof NoPerson && (v2.value0.value0.value1 < v1.value0.value1 && v2.value0.value0.value0 === v1.value0.value0))) {
                          return Move.create(v2)(North.value);
                      };
                      if (v4 instanceof NoPerson) {
                          return Toggle.create(Data_Maybe.Nothing.value);
                      };
                      return Toggle.create(new Data_Maybe.Just(new PersonCell(v1.value0, v1.value1)));
                  };
              };
          };
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("box " + toggledClass(v.toggledPerson))), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(clickHandler(v.toggledPerson)(v1.value0)(v1.value1))) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(walls)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(people)(destinations)));
      };
  };
  var arrayToHtml = function (state) {
      return function ($633) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("inner")) ])(Data_Functor.map(Data_Functor.functorArray)(cellToHtml(state))(Data_Array.fromFoldable(Data_List_Types.foldableList)($633)));
      };
  };
  var arrayArrayToHtml = function (state) {
      return function ($634) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("outer")) ])(Data_Functor.map(Data_Functor.functorArray)(arrayToHtml(state))(Data_Array.fromFoldable(Data_List_Types.foldableList)($634)));
      };
  };
  var addWalls = function (walls) {
      return function (cells) {
          return Control_Bind.bind(Data_List_Types.bindList)(cells)(function (v) {
              var newCell = Data_Maybe.maybe(v)(Control_Category.identity(Control_Category.categoryFn))(Data_Functor.map(Data_Maybe.functorMaybe)(function (v1) {
                  return new Cell(v1.value0, v.value1, v1.value1, v.value3);
              })(findWall(v.value0)(walls)));
              return Control_Applicative.pure(Data_List_Types.applicativeList)(newCell);
          });
      };
  };
  var addPeople = function (people) {
      return function (cells) {
          return Control_Bind.bind(Data_List_Types.bindList)(cells)(function (v) {
              var newCell = Data_Maybe.maybe(v)(Control_Category.identity(Control_Category.categoryFn))(Data_Functor.map(Data_Maybe.functorMaybe)(function (v1) {
                  return new Cell(v1.value0, v1.value1, v.value2, v.value3);
              })(findPerson(v.value0)(people)));
              return Control_Applicative.pure(Data_List_Types.applicativeList)(newCell);
          });
      };
  };
  var addDestinations = function (destinations) {
      return function (cells) {
          return Control_Bind.bind(Data_List_Types.bindList)(cells)(function (v) {
              var newCell = Data_Maybe.maybe(v)(Control_Category.identity(Control_Category.categoryFn))(Data_Functor.map(Data_Maybe.functorMaybe)(function (v1) {
                  return new Cell(v1.value0, v.value1, v.value2, v1.value1);
              })(findDestination(v.value0)(destinations)));
              return Control_Applicative.pure(Data_List_Types.applicativeList)(newCell);
          });
      };
  };
  var gridToHtml = function (game) {
      return function ($635) {
          return arrayArrayToHtml(game)(groupGrid(addPeople(game.people)(addWalls(game.walls)(addDestinations(game.destinations)($635)))));
      };
  };
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Data_Newtype.wrap(Halogen_HTML_Core.newtypeClassName)("container")) ])([ gridToHtml(state.game)(grid) ]);
      };
      var initialState = {
          game: {
              walls: initWalls,
              ...
              toggledPerson: Data_Maybe.Nothing.value
          }
      };
      var $$eval = function (v) {
          if (v instanceof Move && v.value0 instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  return v1.game;
              }))(function (v1) {
                  var obstacledGrid = addWalls(v1.walls)(addPeople(v1.people)(grid));
                  var v2 = movePerson(v.value0.value0)(v.value1)(obstacledGrid);
                  var newPeople = Data_Functor.map(Data_List_Types.functorList)(function (v3) {
                      var $599 = Data_Eq.eq(eqPerson)(v2.value1)(v3.value1);
                      if ($599) {
                          return v2;
                      };
                      return v3;
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $605.game = (function () {
                          var $602 = {};
                          for (var $603 in s.game) {
                              if ({}.hasOwnProperty.call(s.game, $603)) {
                                  $602[$603] = s["game"][$603];
                              };
                          };
                          $602.people = newPeople;
                          return $602;
                      })();
                      return $605;
                  }))(function (v3) {
          ...
          if (v instanceof Move && v.value0 instanceof Data_Maybe.Nothing) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
          };
          if (v instanceof Toggle) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  var $624 = {};
                  for (var $625 in s) {
                      if ({}.hasOwnProperty.call(s, $625)) {
                          $624[$625] = s[$625];
                      };
                  };
                  $624.game = (function () {
                      var $621 = {};
                      for (var $622 in s.game) {
                          if ({}.hasOwnProperty.call(s.game, $622)) {
                              $621[$622] = s["game"][$622];
                          };
                      };
                      $621.toggledPerson = v.value0;
                      return $621;
                  })();
                  return $624;
              }))(function (v1) {
          ...
          throw new Error("Failed pattern match at Main line 378, column 12 - line 405, column 18: " + [ v.constructor.name ]);
      };
  ...
  exports["DestinationCell"] = DestinationCell;
  exports["initWalls"] = initWalls;
  exports["findWall"] = findWall;
  exports["initPeople"] = initPeople;
  exports["findPerson"] = findPerson;
  exports["initDestinations"] = initDestinations;
  exports["findDestination"] = findDestination;
  exports["grid"] = grid;
  exports["groupGrid"] = groupGrid;
  exports["addWalls"] = addWalls;
  exports["addPeople"] = addPeople;
  exports["addDestinations"] = addDestinations;
  exports["filt"] = filt;
  exports["movePerson"] = movePerson;
  exports["gridToHtml"] = gridToHtml;
  exports["arrayArrayToHtml"] = arrayArrayToHtml;
  exports["arrayToHtml"] = arrayToHtml;
  exports["cellToHtml"] = cellToHtml;
  exports["ui"] = ui;
  exports["main"] = main;
  exports["genericPerson"] = genericPerson;
  exports["genericCoord"] = genericCoord;
  exports["genericWall"] = genericWall;
  exports["genericCell"] = genericCell;
  exports["genericWallCell"] = genericWallCell;
  exports["genericPersonCell"] = genericPersonCell;
  exports["genericDirection"] = genericDirection;
  exports["genericTile"] = genericTile;
  exports["genericDestination"] = genericDestination;
  exports["genericDestinationCell"] = genericDestinationCell;
  exports["showPerson"] = showPerson;
  exports["showCoord"] = showCoord;
  exports["showWall"] = showWall;
  exports["showCell"] = showCell;
  exports["showWallCell"] = showWallCell;
  exports["showPersonCell"] = showPersonCell;
  exports["showDirection"] = showDirection;
  exports["showTile"] = showTile;
  exports["showDestination"] = showDestination;
  exports["showDestinationCell"] = showDestinationCell;
  exports["eqCoord"] = eqCoord;
  exports["ordCoord"] = ordCoord;
  exports["eqPerson"] = eqPerson;
  exports["eqPersonCell"] = eqPersonCell;
  exports["ordPerson"] = ordPerson;
  exports["eqWall"] = eqWall;
  exports["ordWall"] = ordWall;
  exports["eqCell"] = eqCell;
  exports["ordCell"] = ordCell;
  exports["eqTile"] = eqTile;
  exports["ordTile"] = ordTile;
  exports["eqDestination"] = eqDestination;
  exports["ordDestination"] = ordDestination;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
},{}]},{},[1]);
